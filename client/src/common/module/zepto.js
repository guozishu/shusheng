...
(function (global, factory) {
  ...
  ;(function ($) {
    ...
    function ajaxSuccess (data, xhr, settings, deferred) {
      var context = settings.context; var status = 'success'
    ...
    $.ajaxJSONP = function (options, deferred) {
      ...
      var xhr = { abort: abort }; var abortTimeout
    ...
    function serializeData (options) {
      ...
      if (options.data && (!options.type || options.type.toUpperCase() == 'GET' || options.dataType == 'jsonp')) { options.url = appendQuery(options.url, options.data), options.data = undefined }
    }

    $.ajax = function (options) {
      var settings = $.extend({}, options || {})
      var deferred = $.Deferred && $.Deferred()
      var urlAnchor; var hashIndex
      ...
      var dataType = settings.dataType; var hasPlaceholder = /\?.+=\?/.test(settings.url)
      ...
      var headers = { }
      var setHeader = function (name, value) { headers[name.toLowerCase()] = [name, value] }
    ...
    $.fn.load = function (url, data, success) {
      ...
      var self = this; var parts = url.split(/\s/); var selector
    ...
    function serialize (params, obj, traditional, scope) {
      var type; var array = $.isArray(obj); var hash = $.isPlainObject(obj)
  ...
  ;(function ($, undefined) {
    var prefix = ''; var eventPrefix
    var vendors = { Webkit: 'webkit', Moz: '', O: 'o' }
    var testEl = document.createElement('div')
    var supportedTransforms = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i
    var transform
    var transitionProperty; var transitionDuration; var transitionTiming; var transitionDelay
    var animationName; var animationDuration; var animationTiming; var animationDelay
    var cssReset = {}
  ...
  cssReset[animationTiming = prefix + 'animation-timing-function'] = ''
    ...
    $.fn.anim = function (properties, duration, ease, callback, delay) {
      var key; var cssValues = {}; var cssProperties; var transforms = ''
      var that = this; var wrappedCallback; var endEvent = $.fx.transitionEnd
      var fired = false
  ...
  ;(function ($, undefined) {
    var document = window.document
    var origShow = $.fn.show; var origHide = $.fn.hide; var origToggle = $.fn.toggle
    ...
    $.fn.toggle = function (speed, callback) {
      if (speed === undefined || typeof speed === 'boolean') { return origToggle.call(this, speed) } else {
        return this.each(function () {
          var el = $(this)
  ...
  ;(function ($) {
            ...
            $.each(tuples, function (i, tuple) {
              ...
              deferred[tuple[1]](function () {
                ...
                if (returned && $.isFunction(returned.promise)) {
                  ...
                  var values = fn ? [returned] : arguments
    ...
    $.when = function (sub) {
      ...
      var i = 0
      var remain = len !== 1 || (sub && $.isFunction(sub.promise)) ? len : 0
  ...
  ;(function ($) {
    var zepto = $.zepto; var oldQsa = zepto.qsa; var oldMatches = zepto.matches
    ...
    var childRe = /^\s*>/
    var classTag = 'Zepto' + (+new Date())

    function process (sel, fn) {
    // quote the hash in `a[href^=#]` expression
      sel = sel.replace(/=#\]/g, '="#"]')
      var filter; var arg; var match = filterRe.exec(sel)
